...
# You would only use/need this script if using script_info {"type" = "account_menu", "name" = "xxx", "script_file" = "context_actions_accts.py"}
...
myPrint(u"@@ Extension Tester >> context_actions_accts.py was invoked.")
...
if u"thisObjectExistsEverywhere" in globals():
    myPrint(u"context_actions_accts.py - 'thisObjectExistsEverywhere' exists and contains: %s" %(thisObjectExistsEverywhere))
    ...
    myPrint(u"context_actions_accts.py - Uh-Oh 'thisObjectExistsEverywhere' does not exist?")
