...
- Read-Only mode: Buttons
    ...
    - MENU: Online Banking Tools (for OFX/DC and MD+):
        ...
        - View your Security's hidden Identifiers (e.g. CUSIP, ISIN, SEDOL, TICKER) (the internal link for downloaded securities....)
    ...
    - MENU: Currency & Security tools:
        ...
        - DIAG - Validate dated price record exists on security split date(s)
        - DIAG - List all security split data (also performs validation)
