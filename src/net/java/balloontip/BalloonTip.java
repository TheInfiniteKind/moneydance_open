...
public class BalloonTip extends JPanel {
	 ...
	 */
	public JButton getDefaultCloseButton() {
		Image defaultCloseImage  = getImage("/net/java/balloontip/images/close_default.png");
		Image rolloverCloseImage = getImage("/net/java/balloontip/images/close_rollover.png");
		Image pressedCloseImage  = getImage("/net/java/balloontip/images/close_pressed.png");
		...
		if(defaultCloseImage != null){
			Icon defaultCloseIcon  = new ImageIcon(defaultCloseImage);
			button.setIcon(defaultCloseIcon);
		}
		if(rolloverCloseImage != null){
			Icon rolloverCloseIcon = new ImageIcon(rolloverCloseImage);
			button.setRolloverIcon(rolloverCloseIcon);
		}
		if(pressedCloseImage != null){
			Icon pressedCloseIcon  = new ImageIcon(pressedCloseImage);
	 ...
	 */
	/*
	public void setDefaultCloseButtonIcons(Icon normal, Icon pressed, Icon rollover) {
