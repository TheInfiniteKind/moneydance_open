...
public class BudgetDocumentRenderer implements Printable {
        /*
         * BudgetDocumentRenderer prints objects of type Document. Text attributes,
        ...
        protected void printDialog() {
                if (pJob.printDialog()) {
                        ...
                        try {
                                ...
                                pageEndY = 0;
                                currentPage = -1;
                                System.err.println("Error Printing Document");
                        }
                }
        }
