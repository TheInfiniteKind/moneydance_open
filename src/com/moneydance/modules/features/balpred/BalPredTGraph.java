  ...
  extends BalPredGraph 
{
  ...
  public BalPredTGraph(LineGraphModel model, Resources rr) {
    super(model,rr);
  }
  ...
  public synchronized void drawGraph(Graphics g, int w, int h, boolean printing) {
    ...
    int xpoly[] = new int[4];
    int ypoly[] = new int[4];
    xpoly[0] = (int)(leftMargin+(model.getDataSetXValue(0, 0)-minX)*xScale);
    ypoly[0] = (int)(h-bottomMargin-(model.getDataSetYValue(0, 0)-minY)*yScale);
    xpoly[1] = (int)(leftMargin+(model.getDataSetXValue(0, -1)-minX)*xScale);
    ypoly[1] = (int)(h-bottomMargin-(model.getDataSetYValue(0, -1)-minY)*yScale);
    xpoly[2] = (int)(leftMargin+(model.getDataSetXValue(2, -1)-minX)*xScale);
    ypoly[2] = (int)(h-bottomMargin-(model.getDataSetYValue(2, -1)-minY)*yScale);
    xpoly[3] = (int)(leftMargin+(model.getDataSetXValue(2, 0)-minX)*xScale);
    ypoly[3] = (int)(h-bottomMargin-(model.getDataSetYValue(2, 0)-minY)*yScale);
    g.setColor(new Color(-3342337));
