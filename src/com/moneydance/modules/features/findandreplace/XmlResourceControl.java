...
class XmlResourceControl extends ResourceBundle.Control
{
    ...
    static
    {
        ...
        formats.add(N12EFindAndReplace.FORMAT_XML);
            ...
            throws IllegalAccessException, InstantiationException, IOException
    {
        ...
        if (!N12EFindAndReplace.FORMAT_XML.equals(format))
        {
            return super.newBundle(baseName, locale, format, loader, reload);
        }

        String bundleName = toBundleName(baseName, locale);
        String resourceName = toResourceName(bundleName, N12EFindAndReplace.FORMAT_XML_SUFFIX);
